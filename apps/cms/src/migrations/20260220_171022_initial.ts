...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "versions_blocks_link_locales" (
  	"label" varchar,
  	"description" varchar,
  	"url" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "versions_blocks_workflow_locales" (
  	"label" varchar,
  	"description" varchar,
  ...
  CREATE TABLE "versions_contact_methods_address_locales" (
  ...
  CREATE TABLE "versions_contact_methods_email_locales" (
  	"label" varchar NOT NULL,
  	"description" varchar,
  ...
  CREATE TABLE "versions_contact_methods_fax_locales" (
  	"label" varchar NOT NULL,
  	"description" varchar,
  	"value" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "versions_contact_methods_phone_locales" (
  	"label" varchar NOT NULL,
  	"description" varchar,
  	"value" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "versions_contact_methods_web_locales" (
  	"label" varchar NOT NULL,
  	"description" varchar,
  	"value" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "versions_faq_locales" (
  	"question" varchar,
  	"answer" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "versions_resources_locales" (
  	"label" varchar,
  	"url" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  ALTER TABLE "versions_blocks_link_locales" ADD CONSTRAINT "versions_blocks_link_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."versions_blocks_link"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "versions_blocks_workflow_locales" ADD CONSTRAINT "versions_blocks_workflow_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."versions_blocks_workflow"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "versions_faq_locales" ADD CONSTRAINT "versions_faq_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."versions_faq"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "versions_blocks_link_locales_locale_parent_id_unique" ON "versions_blocks_link_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "versions_blocks_workflow_locales_locale_parent_id_unique" ON "versions_blocks_workflow_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "versions_faq_locales_locale_parent_id_unique" ON "versions_faq_locales" USING btree ("_locale","_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "versions_blocks_link_locales" CASCADE;
  DROP TABLE "versions_blocks_workflow" CASCADE;
  DROP TABLE "versions_blocks_workflow_locales" CASCADE;
  DROP TABLE "versions_contact_methods_address" CASCADE;
  DROP TABLE "versions_contact_methods_address_locales" CASCADE;
  DROP TABLE "versions_contact_methods_email" CASCADE;
  DROP TABLE "versions_contact_methods_email_locales" CASCADE;
  DROP TABLE "versions_contact_methods_fax" CASCADE;
  DROP TABLE "versions_contact_methods_fax_locales" CASCADE;
  DROP TABLE "versions_contact_methods_phone" CASCADE;
  DROP TABLE "versions_contact_methods_phone_locales" CASCADE;
  DROP TABLE "versions_contact_methods_web" CASCADE;
  DROP TABLE "versions_contact_methods_web_locales" CASCADE;
  DROP TABLE "versions_faq" CASCADE;
  DROP TABLE "versions_faq_locales" CASCADE;
  DROP TABLE "versions_resources" CASCADE;
  DROP TABLE "versions_resources_locales" CASCADE;
